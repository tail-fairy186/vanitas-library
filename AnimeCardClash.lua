...
local WindUI = loadstring(game:HttpGet("https://github.com/Footagesus/WindUI/releases/download/" .. Version .. "/main.lua"))()
	...
	-- Net
	local Net = {
        inviteDungeon = ReplicatedStorage:WaitForChild("games/acc/src/shared/network@eventDefinitions"):WaitForChild("dungeonInviteToTeam"),
		depositOrnament = ReplicatedStorage:WaitForChild("games/acc/src/shared/network@eventDefinitions"):WaitForChild("depositOrnament"),
		tradeOrnament = ReplicatedStorage:WaitForChild("games/acc/src/shared/network@eventDefinitions"):WaitForChild("tradeOrnament"),
		teleportmap = ReplicatedStorage:WaitForChild("games/acc/src/shared/network@eventDefinitions"):WaitForChild("teleport"),
		startdungeon = ReplicatedStorage:WaitForChild("games/acc/src/shared/network@eventDefinitions"):WaitForChild("dungeonStart"),
		...
		buyDungeonUpgrade = ReplicatedStorage:WaitForChild("games/acc/src/shared/network@eventDefinitions"):WaitForChild("buyDungeonUpgrade"),
		buyStockItem = ReplicatedStorage:WaitForChild("games/acc/src/shared/network@eventDefinitions"):WaitForChild("buyChristmasStockShopItem"),
		buyEventDailyItem = ReplicatedStorage:WaitForChild("games/acc/src/shared/network@eventDefinitions"):WaitForChild("buyChristmasItemShopListing"),
	}
